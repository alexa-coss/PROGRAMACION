from .rotacion import rotacion  # Función que retorna ruta video rotado
from .corregir_movimiento import corregir_movimiento  # Función que selecciona punto, corrige movimiento y guarda
from .seguimiento import seguimiento  # Función que hace tracking final
import os

def video(ruta_video_original):

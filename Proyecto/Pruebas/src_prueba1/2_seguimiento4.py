...
# Abrir video
video = cv2.VideoCapture('../videos/Videos_pelota/fondo_cafe_3.MOV')
...
instrucciones = [
    "Instrucciones",
    "Selecciona el objeto a seguir en un recuadro.",
...
video_salida = cv2.VideoWriter('salida_seguimiento.mp4', fourcc, fps_video, (ancho_pantalla, alto_pantalla))
...
with open("2_seguimiento.txt", "w") as archivo: # Abrir o crea archivo 'trayectoria.txt' en modo escritura 'w'. (Si ya existe, sobrescribir)

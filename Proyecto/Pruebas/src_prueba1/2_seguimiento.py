...
def seguimiento(ruta_video_preprocesado):
    ...
    # Abrir video
    video = cv2.VideoCapture(ruta_video_preprocesado)
    ...
    ruta_video_preprocesado = os.path.join(ruta_datos, "video_seguimiento.mp4")
    video_salida = cv2.VideoWriter(ruta_video_preprocesado, fourcc, fps_video, (ancho_pantalla, alto_pantalla))

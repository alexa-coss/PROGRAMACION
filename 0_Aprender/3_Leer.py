...
cap = cv2.VideoCapture('Video.mp4') # cv2.VideoCapture(0) → Crea un objeto VideoCapture que abre el archivo.
#save = cv2.VideoWriter('Video.avi',cv2.VideoWriter_fourcc(*'XVID'),20.0,(640,480))
